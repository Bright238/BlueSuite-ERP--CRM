...
import EmployeeList from '../views/dashboard/app/employee-list';
...
import Departments from '../views/dashboard/app/departments';
import SkillsList from '../views/dashboard/app/skills-list';
import CertificationList from '../views/dashboard/app/certification-list';
import Projects from '../views/dashboard/app/projects';
...
export const DefaultRouter = [
    {
        ...
        children: [
            ...
            },
            {
             ...
             {
                path: 'dashboard/app/employee-list',
                element: <EmployeeList />
            },
             {
                path: 'dashboard/app/departments',
                element: <Departments />
            },
             {
                path: 'dashboard/app/skills',
                element: <SkillsList />
            },
             {
                path: 'dashboard/app/certifications',
